!(function () {
  ...
  function modulesCallback(result, dependantData) {
    JSHON.import[dependantData.pathname].loadResult[dependantData.position] =
      result;
    if (!dependantData.regulator.firstload) {
      ...
      if (
        ...
        if (
          ...
          JSHON[symbolIdentifier + "currentPathname"] =
            JSHON.import[dependantData.pathname].main;
      ...
      if (
        JSHON.import[dependantData.pathname].successful.indexOf(
      ...
      if (
        ...
        var totalReq =
          dependantData.regulator.requests +
          JSHON.import[dependantData.pathname].successful.length;
  ...
  setFreezedObjectProperty(
    setFreezedObjectProperty(window, "JSHON", JSHONImportExportModule).JSHON,
    "loadPage",
    loadPage
  );
  setFreezedObjectProperty(
    setFreezedObjectProperty(JSHON, "exports", {}),
    symbolIdentifier + "imports",
    {}
  );
  setFreezedObjectProperty(
    setFreezedObjectProperty(JSHON, "import", {}),
    symbolIdentifier + "requested",
    {}
  );
  setFreezedObjectProperty(
    setWritableObjectProperty(JSHON, symbolIdentifier + "currentPathname", ""),
    "reloadModule",
    reloadModule
  );
  setFreezedObjectProperty(
    setFreezedObjectProperty(JSHON, "loadModule", loadModule),
    "include",
    function JSHONExternalImports(src) {
      var currentFilename = symbolIdentifier + "currentPathname";
  ...
  setFreezedObjectProperty(
    setFreezedObjectProperty(JSHON.import, "global", {}),
    "from",
    function JSHONInternalImports(src) {
  ...
  setFreezedObjectProperty(
    JSHON,
    "includesModule",
    function JSHONIncludesModule(src) {
