...
function newPage({
  ...
  const JSH = {
          ...
          var ssrHtml = require(htmlEntryPath)(
            {
              ...
              render: function () {
                ...
                var inline_dependencies =
                    `<script id="jshon-starter-script">!function(){var at=JSHON.PAGEDATA;JSHON.PAGEDATA=${stringifyValue(
                      data
                    )};` +
                    ...
                    `${textSeparatorScript};Object.defineProperty(JSHON,'inline_modules',{value:function JSHONInlineModules(){return {`,
                  i;
                if (jserve.dev) {
                ...
                return (
                  /*'<i class="jshon-d-node" j-type="element"></i>'+*/ JSH.ui.render(
                    renderingPage.ref,
                    renderingPage.args
    ...
    getRightValue: function (value, ignoreArray) {
      ...
      if (typeof value == "object") {
        if (null == value) {
          ...
          if (!ignoreArray) {
            ...
            return `<i class="jshon-d-node" j-type="list" j-len="${
              value.length
      ...
      if (ignoreArray) {
        return `<noscript class="jshon-d-text">${_In_Escape(
          value + ""
        )}</noscript>`;
      }
      return `<i class="jshon-d-node" j-type="text"></i><noscript class="jshon-d-text">${_In_Escape(
        value + ""
      )}</noscript>`;
    },
  };
        ...
        require(compiled_htmlEntryPath)(
          {
            ...
            render: function () {
              var merger =
                `<script>!function(){var at=JSHON.PAGEDATA;JSHON.PAGEDATA=${stringifyValue(
                  pageData
                )};` +
                `var atk=Object.keys(at);for(var z=0;z<atk.length;z++){JSHON.PAGEDATA[atk[z]]=typeof(JSHON.PAGEDATA[atk[z]])=='undefined'?at[atk[z]]:JSHON.PAGEDATA[atk[z]]};` +
                `}()</script>`;
